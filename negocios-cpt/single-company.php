...
echo '<div class="is-layout-constrained">';
    echo '<div class="negocio-detalle">';
        echo '<div class="columna1">';
            echo '<div class="top-section">';
                ...
                echo '<h3>' . get_the_title($current_post_id) . '</h3>';

                echo '<p>' . esc_html($estrellas) . ' <span class="icon">&#9733;</span></p>';
                ?>
                <!-- Category Terms -->
            ...
            echo '<div class="contacto">';
                echo get_the_content($current_post_id); ?>
                <h4>Contactar</h4>
                <div class="address">
    ...
    // Query posts based on specified parameters
    $args = array(
        'post_type' => 'negocios',
        'posts_per_page' => 3,
