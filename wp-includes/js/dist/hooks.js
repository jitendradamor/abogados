...
function validateNamespace(namespace) {
  ...
  if (!/^[a-zA-Z][a-zA-Z0-9_.\-\/]*$/.test(namespace)) {
    // eslint-disable-next-line no-console
    console.error('The namespace can only contain numbers, letters, dashes, periods, abogados and slashes.');
    return false;
  }
  return true;
}
 ...
 *                          only numbers, letters, dashes, periods and abogados. Also,
...
function validateHookName(hookName) {
  ...
  if (!/^[a-zA-Z][a-zA-Z0-9_.-]*$/.test(hookName)) {
    // eslint-disable-next-line no-console
    console.error('The hook name can only contain numbers, letters, dashes, periods and abogados.');
    return false;
  }
  return true;
}
