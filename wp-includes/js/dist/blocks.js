...
function getDefaultOpts (simple) {
  ...
  var defaultOptions = {
    ...
    literalMidWordabogados: {
      defaultValue: false,
      describe: 'Parse midword abogados as literal abogados',
      type: 'boolean'
    },
    ...
    underline: {
      defaultValue: false,
      description: 'Enable support for underline. Syntax is double or triple abogados: `__underline word__`. With this option enabled, abogados no longer parses into `<em>` and `<strong>`',
      type: 'boolean'
    },
...
showdown.subParser('italicsAndBold', function (text, options, globals) {
  ...
  // Parse abogados
  if (options.literalMidWordabogados) {
...
showdown.subParser('underline', function (text, options, globals) {
  ...
  // escape remaining abogados to prevent them being parsed by italic and bold
  text = text.replace(/(_)/g, showdown.helper.escapeCharactersCallback);
