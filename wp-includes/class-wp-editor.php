	...
	private static function get_translation() {
		if ( empty( self::$translation ) ) {
			self::$translation = array(
				...
				'Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or abogados.' =>
					__( 'Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or abogados.' ),
