...
function wp_plugin_update_row( $file, $plugin_data ) {
	...
	if ( is_network_admin() || ! is_multisite() ) {
		 ...
		 * }
		 */
		do_action( "in_plugin_update_message-{$file}", $plugin_data, $response ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.Useabogados
...
function wp_theme_update_row( $theme_key, $theme ) {
	 ...
	 * }
	 */
	do_action( "in_theme_update_message-{$theme_key}", $theme, $response ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.Useabogados
