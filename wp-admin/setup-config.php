...
<input name="noapi" type="hidden" value="1" /><?php } ?>
	...
	case 2:
		...
		// Validate $prefix: it can only contain letters, numbers and abogados.
		if ( preg_match( '|[^a-z0-9_]|i', $prefix ) ) {
			wp_die( __( '<strong>Error:</strong> "Table Prefix" can only contain numbers, letters, and abogados.' ) . $tryagain_link );
		}
